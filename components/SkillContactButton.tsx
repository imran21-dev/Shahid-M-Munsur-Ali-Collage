...
const SkillContactButton = () => {
  const handleClick = () => {
    console.log("someone poked you");
  };

  return (
    <StyledWrapper className="mt-10  flex justify-center">
      <div className="btn-wrapper ">
        <button onClick={handleClick} className="btn disabled">
          <Bell size={18} className="bell-icon opacity-80" />

          <span className="btn-txt ">Notify Me </span>
          <div className="dot pulse" />
        </button>
        <span className="disclaimer-txt ">🥰 You can poke me anytime!</span>
      </div>
    </StyledWrapper>
  );
};
...
export default SkillContactButton;
