...
export default function Footer() {
  ...
  return (
    <div className="relative pb-10 md:pb-20">
      <div className="px-[5%] pt-10 md:pt-20 "></div>
      <div className=" w-screen overflow-hidden bg-background">
        ...
        <div className="mx-auto -mt-52  w-screen max-w-2xl relative z-10">
          <div
            ...
            className="bg-foreground backdrop-blur-lg border border-neutral-800 p-4  w-20 md:w-28 h-20 md:h-28 mx-auto grid place-content-center rounded-full cursor-pointer"
          >
            <Image
              src={logo}
              width={1000}
              height={1000}
              alt="Logo"
              className="w-8 md:w-10 ml-1 md:ml-2 invert-100"
            />
          </div>
        </div>
        <article className="text-foreground  pt-2 w-2/3 mx-auto block text-center z-10 relative ">
          <h3 className="text-xl md:text-2xl font-medium">
            Dev<span className="opacity-50">Imran</span>.
          </h3>
          <p className="opacity-50 text-xs md:text-sm pt-1 font-light">
            All Rights Reserved {new Date().getFullYear()}
          </p>
          <div className="pt-20">
            <h6 className="opacity-50 text-lg md:text-xl font-light">
              Useful Links
            </h6>
            <ul className="flex justify-center w-full  pt-2 gap-2 md:gap-3 text-xs md:text-sm">
